...
const MenuFrenchStarters: React.FC<StartersProps> = ({ marches }) => {
  ...
  const genreMapping: { [key: string]: string } = {
    ...
    yakitori: 'Yakitori Brochettes grillées (par pièce)',
    rice: 'Riz',
  }
  ...
  return (
    <div className={styles.Starters} id="Starters">
      <div className={styles.container}>
        <div key={category}>
          <h2 className={styles.category}>HORS D’ŒUVRES & PLATS</h2>
...
export default MenuFrenchStarters
