...
const langs: LangItem[] = [
  ...
  {
    title: 'EN',
    path: '/en/sushigourmet',
  },
  {
    title: 'JP',
    path: '/jp/sushigourmet',
  },
]
...
const NavbarGourmet = () => {
  ...
  return (
    <div className={styles.NavbarGourmet}>
      <div className={styles.Navbar_container}>
        ...
        <ul className={styles.Navbar_list_right}>
          ...
          <li className={styles.sushiMarcheLink}>
            <Link
